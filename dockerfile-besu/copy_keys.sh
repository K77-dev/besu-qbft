...
directory="/besu-25.3.0/QBFT-Network/networkFiles/keys"
...
for index in "${!folders[@]}"; do
        ...
        cp -r "$directory/$folder"/* "/besu-25.3.0/QBFT-Network/Node-$n_index/data/"
done

#Copia o arquivo Genesis para a pasta correta
cp /besu-25.3.0/QBFT-Network/networkFiles/genesis.json /besu-25.3.0/QBFT-Network/