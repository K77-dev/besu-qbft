...
n2_path=/besu-25.3.0/QBFT-Network/Node-2/cfg_n2.toml
...
echo '# graphql' >> $n2_path
echo 'graphql-http-enabled=true' >> $n2_path
echo 'graphql-http-host="0.0.0.0"' >> $n2_path
echo 'graphql-http-port=9546' >> $n2_path
echo 'graphql-http-cors-origins=["all"]' >> $n2_path
echo -e "\n" >> $n2_path
...
#echo -e "\n" >> $n2_path
#echo '# Plugin DINAMO' >> $n2_path
#echo 'security-module="dinamo"' >> $n2_path

#cat $n2_path



cd /besu-25.3.0/QBFT-Network/Node-2
